...
pointList=gct.genTrajectory(__file__.split("TormachZA6CNC")[0]+'TormachZA6CNC/Gcode/'+file, a=30,hz=hz,feedRate=20,rapidFeed=20,toolFrameOffset=np.array([500,50,500]),toolFrameRot=tfRot, pureRotVel=np.pi/40, tOffset=[0, 0], origin=posInit, toolIJKInit=toolIJKInit)
...
for point in pointList:
	...
	pick.append(ik.chooseIK(pick[c-1],newsol,[20,20,20,20,20,20,0,2,2,2,2,2,2]))
...
gct.plot3DTrajectory(pointList, hz, nmin=0, nmaxOffset=0, step=1, titleFile = file)
