...
class MovePoseActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MovePoseFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MovePoseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MovePoseActionFeedback(null);
    ...
    data.feedback = MovePoseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovePoseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MovePoseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MovePoseFeedback()
    }
...
module.exports = MovePoseActionFeedback;
