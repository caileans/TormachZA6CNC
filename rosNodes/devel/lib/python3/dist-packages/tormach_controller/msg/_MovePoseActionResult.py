...
"""autogenerated by genpy from tormach_controller/MovePoseActionResult.msg. Do not edit."""
import codecs
import sys
...
class MovePoseActionResult(genpy.Message):
  _md5sum = "9563d3c28762c458792c0215fe7e8cb8"
  _type = "tormach_controller/MovePoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tormach_controller/MovePoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MovePoseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tormach_controller.msg.MovePoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tormach_controller.msg.MovePoseResult()
