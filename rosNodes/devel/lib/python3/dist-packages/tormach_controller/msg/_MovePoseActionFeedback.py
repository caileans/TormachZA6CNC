...
"""autogenerated by genpy from tormach_controller/MovePoseActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MovePoseActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "tormach_controller/MovePoseActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tormach_controller/MovePoseFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MovePoseActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = tormach_controller.msg.MovePoseFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tormach_controller.msg.MovePoseFeedback()
